...
export function Register() {
  ...
  const { setPendingVerificationEmail, setPendingRegistration, setAuth } = useAuthStore();
        ...
        <div className="glass-panel p-8 sm:p-10 rounded-[2.5rem]">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-1">
              <div className="relative">
                ...
                <Input 
                  ...
                  className="pl-10 bg-background/50 border-white/10 h-12 focus-visible:ring-accent"
                />
              </div>
              {errors.name && <p className="text-destructive text-sm font-medium pl-1">{errors.name.message}</p>}
            </div>
            ...
            <div className="space-y-1">
              <div className="relative">
                ...
                <Input                      
                      ...
                      className="pl-10 pr-10 bg-background/50 border-border/50 h-12 focus-visible:ring-primary"
                    />
                <button
                  type="button"
            ...
            <div className="space-y-1">
              ...
              {errors.phoneNumber && <p className="text-destructive text-sm font-medium pl-1">{errors.phoneNumber.message}</p>}
            </div>
